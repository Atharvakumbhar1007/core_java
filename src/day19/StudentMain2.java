...
public class StudentMain2 {
	...
	public static void main(String[] args) {
		...
		students.add(new Student(19,"Nikhil Shine","Civil",91.22));
		students.add(new Student(30,"Rohit Nenu","AIML",61.22));
		students.add(new Student(8,"Nikhil Shine","Civil",91.22));
		students.add(new Student(6,"Om Shine","Electrronic",91.22));
		
		System.out.println("----------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
		System.out.println("Before sorting by Percentage");
		students.forEach(stud-> System.out.println(stud));

		Comparator<Student> comparator = (s1,s2)-> (Double.compare(s2.getPercentage(), s1.getPercentage()) == 0)? 
